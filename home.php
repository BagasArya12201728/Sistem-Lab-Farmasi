...
<head>
  ...
  <title>Lab Farmasi IMY</title>
  <link rel="shortcut icon" href="img/farm.png" />
  ...
  <div id="wrapper">
    ...
    <ul class="navbar-nav sidebar bg-gradient-primary sidebar-dark accordion" id="accordionSidebar" >
      ...
      <a class="sidebar-brand d-flex align-items-center justify-content-center" href="?p=dashboard">
        ...
        <div class="sidebar-brand-text mx-3"><img src="img/farm.png" width="50"></div>
        <b>Lab Farmasi</b>
      </a>
      ...
      <footer class="sticky-footer bg-white">
        <div class="container my-auto">
          <div class="copyright text-center my-auto">
            Copyright &#169; <script type='text/javascript'>var creditsyear = new Date();document.write(creditsyear.getFullYear());</script>  SMK Insan Mulia Yogyakarta || Created By KKL 4 EL Rahma </a>
          </div>
        </div>
      </footer>
      <!-- End of Footer -->
